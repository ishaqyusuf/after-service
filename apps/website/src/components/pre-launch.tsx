...
export function PreLaunchPage() {
  ...
  return (
    <div className="fullscreen-landing relative min-height-screen bg-[#fbfcf8] dark:bg-[#070c08] text-[#18211c] dark:text-white overflow-hidden flex flex-col justify-between py-12 px-6 sm:px-12 transition-colors duration-300">
      ...
      <header className="relative z-10 max-w-7xl mx-auto w-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Badge tone="success">PRE-LAUNCH</Badge>
        </div>
      </header>
      ...
      <main className="relative z-10 max-w-4xl mx-auto w-full text-center flex-1 flex flex-col justify-center my-16">
        ...
        <div className="max-w-md mx-auto w-full mb-16">
          {submitted ? (
            <div className="bg-[#eef8f0]/80 dark:bg-[#122118]/80 border border-[#a9d3b7] dark:border-[#1b3d2b] rounded-2xl p-6 backdrop-blur-md shadow-2xl animate-fade-in transition-colors duration-300">
              ...
              <h3 className="text-xl font-bold text-[#18211c] dark:text-white mb-2">
                You're on the list!
              </h3>
            ...
            <form
              ...
              className="flex flex-col sm:flex-row gap-3 bg-white dark:bg-[#111814]/60 p-2 border border-[#dfe5dc] dark:border-[#1f3026] rounded-2xl shadow-2xl backdrop-blur-md transition-colors duration-300"
            >
              <input
                type="email"
          ...
          {error && (
            <p className="text-red-500 dark:text-red-400 text-sm mt-3 text-left pl-3">
              {error}
            </p>
          )}
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
          <div className="bg-white dark:bg-[#111814]/40 border border-[#dfe5dc] dark:border-[#1f3026] hover:border-[#009b98]/40 p-6 rounded-2xl shadow-sm dark:shadow-none transition-all duration-300 backdrop-blur-sm group">
            ...
            <h3 className="text-lg font-bold mb-2 text-[#18211c] dark:text-white">
              Smart Check-Ins
            </h3>
            ...
            <div className="w-10 h-10 rounded-xl bg-[#f0faf8] dark:bg-[#122118] border border-[#d7f3ed] dark:border-[#1b3d2b] flex items-center justify-center mb-4 text-[#009b98] group-hover:scale-110 transition-transform duration-300">
              ...
              >
                <path
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  d="M11.049 2.927c.3-.921 1.603-.921 1.902 0l1.519 4.674a1 1 0 00.95.69h4.907c.961 0 1.36 1.242.588 1.81l-3.97 2.88a1 1 0 00-.364 1.118l1.518 4.674c.3.922-.755 1.688-1.538 1.118l-3.971-2.88a1 1 0 00-1.176 0l-3.97 2.88c-.783.57-1.838-.197-1.538-1.118l1.518-4.674a1 1 0 00-.364-1.118l-3.97-2.88c-.773-.568-.375-1.81.587-1.81h4.907a1 1 0 00.95-.69l1.519-4.674z"
                />
              </svg>
            </div>
            <h3 className="text-lg font-bold mb-2 text-[#18211c] dark:text-white">
      ...
      <footer className="relative z-10 max-w-7xl mx-auto w-full text-center text-xs text-[#7c8e82] dark:text-[#566e60] mt-16 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex gap-6">
          <a
            href="/privacy"
            className="hover:text-[#18211c] dark:hover:text-white transition-colors duration-200"
          >
            Privacy Policy
          </a>
          <a
