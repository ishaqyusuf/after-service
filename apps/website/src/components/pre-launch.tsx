...
export function PreLaunchPage() {
  ...
  return (
    <div className="relative min-height-screen bg-[#070c08] text-white overflow-hidden flex flex-col justify-between py-12 px-6 sm:px-12">
      ...
      <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] rounded-full bg-[#009b98] opacity-[0.08] blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-10%] right-[-10%] w-[50%] h-[50%] rounded-full bg-[#009b98] opacity-[0.05] blur-[120px] pointer-events-none" />
      ...
      <header className="relative z-10 max-w-7xl mx-auto w-full flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <span className="text-xs bg-[#122118] border border-[#1b3d2b] text-[#54c08b] px-3 py-1 rounded-full font-medium tracking-wide">
            PRE-LAUNCH
          </span>
        </div>
      </header>
      ...
      <main className="relative z-10 max-w-4xl mx-auto w-full text-center flex-1 flex flex-col justify-center my-16">
        {/* Glow pill */}
        <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#122118] border border-[#1b3d2b] text-sm text-[#009b98] font-medium mx-auto mb-8 hover:border-[#009b98]/40 transition-all duration-300">
        ...
        {/* Subtitle */}
        <p className="text-lg sm:text-xl text-[#8fa397] max-w-2xl mx-auto mb-10 leading-relaxed">
        ...
        <div className="max-w-md mx-auto w-full mb-16">
          {submitted ? (
            <div className="bg-[#122118]/80 border border-[#1b3d2b] rounded-2xl p-6 backdrop-blur-md shadow-2xl animate-fade-in">
              <div className="w-12 h-12 rounded-full bg-[#009b98]/20 border border-[#009b98]/40 flex items-center justify-center mx-auto mb-4 text-[#009b98]">
                <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2.5}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" />
                </svg>
              </div>
              <h3 className="text-xl font-bold text-white mb-2">You're on the list!</h3>
              <p className="text-sm text-[#8fa397]">
                Thank you for joining. We will notify you as soon as our private beta opens.
              </p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 bg-[#111814]/60 p-2 border border-[#1f3026] rounded-2xl shadow-2xl backdrop-blur-md">
              <input
                type="email"
                ...
                disabled={loading}
                className="flex-1 px-4 py-3 bg-transparent text-white border-0 outline-none focus:ring-0 placeholder-[#566e60] text-base"
              />
              <button
                type="submit"
                disabled={loading}
          ...
          {error && <p className="text-red-400 text-sm mt-3 text-left pl-3">{error}</p>}
        </div>

        {/* Feature Teaser Cards */}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left">
          <div className="bg-[#111814]/40 border border-[#1f3026] hover:border-[#009b98]/40 p-6 rounded-2xl transition-all duration-300 backdrop-blur-sm group">
            <div className="w-10 h-10 rounded-xl bg-[#122118] border border-[#1b3d2b] flex items-center justify-center mb-4 text-[#009b98] group-hover:scale-110 transition-transform duration-300">
              <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                <path strokeLinecap="round" strokeLinejoin="round" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z" />
              </svg>
            </div>
            <h3 className="text-lg font-bold mb-2 text-white">Smart Check-Ins</h3>
            <p className="text-sm text-[#8fa397] leading-relaxed">
          ...
          <div className="bg-[#111814]/40 border border-[#1f3026] hover:border-[#009b98]/40 p-6 rounded-2xl transition-all duration-300 backdrop-blur-sm group">
            ...
            <h3 className="text-lg font-bold mb-2 text-white">5-Star Reviews</h3>
            <p className="text-sm text-[#8fa397] leading-relaxed">
          ...
          <div className="bg-[#111814]/40 border border-[#1f3026] hover:border-[#009b98]/40 p-6 rounded-2xl transition-all duration-300 backdrop-blur-sm group">
            ...
            <h3 className="text-lg font-bold mb-2 text-white">Repeat Bookings</h3>
            <p className="text-sm text-[#8fa397] leading-relaxed">
      ...
      <footer className="relative z-10 max-w-7xl mx-auto w-full text-center text-xs text-[#566e60] mt-16 flex flex-col sm:flex-row items-center justify-between gap-4">
        <p>© 2026 afterservice. All rights reserved.</p>
        <div className="flex gap-6">
          <a href="#" className="hover:text-white transition-colors duration-200">Privacy Policy</a>
          <a href="#" className="hover:text-white transition-colors duration-200">Terms of Service</a>
          <a href="mailto:hello@afterservice.app" className="hover:text-white transition-colors duration-200">Contact Us</a>
        </div>
      </footer>
    </div>
  );
