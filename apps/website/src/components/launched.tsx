...
export function LaunchedPage() {
  ...
  return (
    <div className="relative min-h-screen bg-[#fbfcf8] dark:bg-[#070c08] text-[#18211c] dark:text-white overflow-hidden flex flex-col justify-between transition-colors duration-300">
      ...
      <header className="sticky top-0 z-50 w-full border-b border-[#dfe5dc] dark:border-[#1f3026] bg-[#fbfcf8]/85 dark:bg-[#070c08]/85 backdrop-blur-md">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 h-18 flex items-center justify-between">
          ...
          <nav className="hidden md:flex items-center gap-8 text-sm font-medium text-[#55625b] dark:text-[#8fa397]">
            <a href="#features" className="hover:text-[#18211c] dark:hover:text-white transition-colors">Features</a>
            <a href="#how-it-works" className="hover:text-[#18211c] dark:hover:text-white transition-colors">How it Works</a>
            <a href="#pricing" className="hover:text-[#18211c] dark:hover:text-white transition-colors">Pricing</a>
            <a href="#faqs" className="hover:text-[#18211c] dark:hover:text-white transition-colors">FAQs</a>
          </nav>
          ...
          <div className="flex items-center gap-4">
            ...
            >
              {theme === "dark" ? (
                <svg className="w-5.5 h-5.5 text-yellow-500" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M12 3v1m0 16v1m9-9h-1M4 12H3m15.364-6.364l-.707.707M6.343 17.657l-.707.707m0-12.728l.707.707m12.728 12.728l.707-.707M12 8a4 4 0 100 8 4 4 0 000-8z" />
                </svg>
              ) : (
                <svg className="w-5.5 h-5.5 text-[#009b98]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                  <path strokeLinecap="round" strokeLinejoin="round" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z" />
                </svg>
              )}
            </button>

            <a href="/login" className="text-sm font-medium text-[#55625b] dark:text-[#8fa397] hover:text-[#18211c] dark:hover:text-white transition-colors">
              Sign In
            </a>
            <a 
              href="/signup" 
      ...
      <section className="relative z-10 max-w-7xl mx-auto w-full px-6 sm:px-8 pt-20 pb-16 text-center">
        ...
        <div className="relative max-w-5xl mx-auto bg-white dark:bg-[#0d1410] border border-[#dfe5dc] dark:border-[#1f3026] rounded-2xl p-4 shadow-xl dark:shadow-2xl backdrop-blur-sm overflow-hidden group transition-colors duration-300">
          ...
          <div className="flex items-center gap-2 mb-4 border-b border-[#dfe5dc] dark:border-[#1b3d2b] pb-3">
            ...
            <span className="ml-4 text-xs text-[#7c8e82] dark:text-[#566e60] font-mono">dashboard.afterservice.app</span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 text-left">
            <div className="md:col-span-1 border-r border-[#dfe5dc] dark:border-[#1b3d2b] pr-4 hidden md:flex flex-col gap-3 text-xs text-[#55625b] dark:text-[#8fa397]">
              <div className="p-2 rounded bg-[#eef8f0] dark:bg-[#122118] text-[#009b98] font-bold">🎯 Follow-Up Board</div>
              <div className="p-2 hover:bg-[#eef8f0]/50 dark:hover:bg-[#122118]/40 rounded transition-colors">👥 Customers</div>
              <div className="p-2 hover:bg-[#eef8f0]/50 dark:hover:bg-[#122118]/40 rounded transition-colors">💼 Jobs & Tickets</div>
              <div className="p-2 hover:bg-[#eef8f0]/50 dark:hover:bg-[#122118]/40 rounded transition-colors">📝 Templates</div>
              <div className="p-2 hover:bg-[#eef8f0]/50 dark:hover:bg-[#122118]/40 rounded transition-colors">⚙️ Settings</div>
            </div>
            ...
            <div className="md:col-span-3 flex flex-col gap-4">
              <div className="flex items-center justify-between border-b border-[#dfe5dc] dark:border-[#1b3d2b] pb-2">
                ...
                <span className="text-xs text-[#7c8e82] dark:text-[#566e60]">Updated just now</span>
              </div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                <div className="bg-[#fcfdfa] dark:bg-[#122118]/50 border border-[#dfe5dc] dark:border-[#1b3d2b] p-3 rounded-xl flex flex-col justify-between min-h-32">
                  <div>
                    <span className="text-[10px] uppercase font-bold text-yellow-600 dark:text-yellow-500 px-2 py-0.5 rounded bg-yellow-100 dark:bg-yellow-950/30 border border-yellow-200 dark:border-yellow-800/40">DUE TODAY</span>
                    <h5 className="font-bold text-sm mt-2 text-[#18211c] dark:text-white">HVAC Maintenance</h5>
                    <p className="text-xs text-[#55625b] dark:text-[#8fa397]">John Doe - Rapid Cooling</p>
                  </div>
                  <div className="flex items-center justify-between mt-4">
                    <span className="text-[10px] text-[#7c8e82] dark:text-[#566e60]">SMS Queued</span>
                ...
                <div className="bg-[#fcfdfa] dark:bg-[#122118]/50 border border-[#dfe5dc] dark:border-[#1b3d2b] p-3 rounded-xl flex flex-col justify-between min-h-32">
                  <div>
                    ...
                    <h5 className="font-bold text-sm mt-2 text-[#18211c] dark:text-white">Plumbing Install</h5>
                    <p className="text-xs text-[#55625b] dark:text-[#8fa397]">Sarah Smith - Shower Leak</p>
                  </div>
                  <div className="flex items-center justify-between mt-4">
                    <span className="text-[10px] text-[#7c8e82] dark:text-[#566e60]">Sent 2h ago</span>
                ...
                <div className="bg-[#fcfdfa] dark:bg-[#122118]/50 border border-[#dfe5dc] dark:border-[#1b3d2b] p-3 rounded-xl flex flex-col justify-between min-h-32">
                  <div>
                    <span className="text-[10px] uppercase font-bold text-green-600 dark:text-green-500 px-2 py-0.5 rounded bg-green-100 dark:bg-green-950/30 border border-green-200 dark:border-green-800/40">REPLIED</span>
                    <h5 className="font-bold text-sm mt-2 text-[#18211c] dark:text-white">Electrical Panel</h5>
                    <p className="text-xs text-[#55625b] dark:text-[#8fa397]">Robert Lee - Breaker Box</p>
                  </div>
                  <div className="flex items-center justify-between mt-4">
                    <span className="text-[10px] text-green-600 dark:text-green-400 font-bold">5-Star Review Left</span>
      ...
      <section className="relative z-10 border-y border-[#dfe5dc] dark:border-[#1f3026] bg-[#f5f6f2] dark:bg-[#0b100d]/60 py-12 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div>
            <h3 className="text-3xl sm:text-4xl font-extrabold text-[#18211c] dark:text-white mb-2">$48M+</h3>
            <p className="text-xs sm:text-sm text-[#55625b] dark:text-[#8fa397] uppercase tracking-wider font-semibold">Service Revenue Tracked</p>
          </div>
          <div>
            <h3 className="text-3xl sm:text-4xl font-extrabold text-[#009b98] mb-2">+31%</h3>
            <p className="text-xs sm:text-sm text-[#55625b] dark:text-[#8fa397] uppercase tracking-wider font-semibold">Repeat Booking Rate</p>
          </div>
          <div>
            <h3 className="text-3xl sm:text-4xl font-extrabold text-[#18211c] dark:text-white mb-2">14,200+</h3>
            <p className="text-xs sm:text-sm text-[#55625b] dark:text-[#8fa397] uppercase tracking-wider font-semibold">5-Star Reviews Driven</p>
          </div>
          <div>
            <h3 className="text-3xl sm:text-4xl font-extrabold text-[#009b98] mb-2">99.2%</h3>
            <p className="text-xs sm:text-sm text-[#55625b] dark:text-[#8fa397] uppercase tracking-wider font-semibold">Conflict Resolution Rate</p>
          </div>
        </div>
      </section>
      ...
      <section id="features" className="relative z-10 max-w-7xl mx-auto w-full px-6 sm:px-8 py-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          <div className="bg-white dark:bg-[#111814]/40 border border-[#dfe5dc] dark:border-[#1f3026] hover:border-[#009b98]/40 p-8 rounded-2xl shadow-sm dark:shadow-none transition-all duration-300 group">
            ...
            <h3 className="text-xl font-bold mb-3 text-[#18211c] dark:text-white">Automated Check-Ins</h3>
          ...
          <div className="bg-white dark:bg-[#111814]/40 border border-[#dfe5dc] dark:border-[#1f3026] hover:border-[#009b98]/40 p-8 rounded-2xl shadow-sm dark:shadow-none transition-all duration-300 group">
            ...
            <h3 className="text-xl font-bold mb-3 text-[#18211c] dark:text-white">Google Review Funnel</h3>
            <p className="text-[#55625b] dark:text-[#8fa397] leading-relaxed text-sm">
          ...
          <div className="bg-white dark:bg-[#111814]/40 border border-[#dfe5dc] dark:border-[#1f3026] hover:border-[#009b98]/40 p-8 rounded-2xl shadow-sm dark:shadow-none transition-all duration-300 group">
            ...
            <h3 className="text-xl font-bold mb-3 text-[#18211c] dark:text-white">Private Conflict Resolution</h3>
            <p className="text-[#55625b] dark:text-[#8fa397] leading-relaxed text-sm">
          ...
          <div className="bg-white dark:bg-[#111814]/40 border border-[#dfe5dc] dark:border-[#1f3026] hover:border-[#009b98]/40 p-8 rounded-2xl shadow-sm dark:shadow-none transition-all duration-300 group">
            ...
            <h3 className="text-xl font-bold mb-3 text-[#18211c] dark:text-white">Repeat Visit Reminders</h3>
            <p className="text-[#55625b] dark:text-[#8fa397] leading-relaxed text-sm">
          ...
          <div className="bg-white dark:bg-[#111814]/40 border border-[#dfe5dc] dark:border-[#1f3026] hover:border-[#009b98]/40 p-8 rounded-2xl shadow-sm dark:shadow-none transition-all duration-300 group">
            ...
            <h3 className="text-xl font-bold mb-3 text-[#18211c] dark:text-white">Staff Leaderboards</h3>
            <p className="text-[#55625b] dark:text-[#8fa397] leading-relaxed text-sm">
          ...
          <div className="bg-white dark:bg-[#111814]/40 border border-[#dfe5dc] dark:border-[#1f3026] hover:border-[#009b98]/40 p-8 rounded-2xl shadow-sm dark:shadow-none transition-all duration-300 group">
            ...
            <h3 className="text-xl font-bold mb-3 text-[#18211c] dark:text-white">Enterprise Grade Security</h3>
            <p className="text-[#55625b] dark:text-[#8fa397] leading-relaxed text-sm">
      ...
      <section id="how-it-works" className="relative z-10 bg-[#f5f6f2]/80 dark:bg-[#0b100d]/40 border-y border-[#dfe5dc] dark:border-[#1f3026] py-24 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6 sm:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            <div className="text-center flex flex-col items-center">
              ...
              <h3 className="text-xl font-bold mb-2 text-[#18211c] dark:text-white">Job Completion</h3>
            ...
            <div className="text-center flex flex-col items-center">
              ...
              <h3 className="text-xl font-bold mb-2 text-[#18211c] dark:text-white">Automated Dispatch</h3>
              <p className="text-sm text-[#55625b] dark:text-[#8fa397] max-w-xs leading-relaxed">
            ...
            <div className="text-center flex flex-col items-center">
              ...
              <h3 className="text-xl font-bold mb-2 text-[#18211c] dark:text-white">Growth & Reactivation</h3>
              <p className="text-sm text-[#55625b] dark:text-[#8fa397] max-w-xs leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch max-w-6xl mx-auto">
          ...
          <div className="bg-white dark:bg-[#111814]/40 border border-[#dfe5dc] dark:border-[#1f3026] p-8 rounded-2xl flex flex-col justify-between shadow-sm dark:shadow-none backdrop-blur-sm">
            <div>
              ...
              <h3 className="text-2xl font-bold mt-2 text-[#18211c] dark:text-white">Starter Plan</h3>
              <p className="text-sm text-[#55625b] dark:text-[#8fa397] mt-2">Perfect for independent owner-operators.</p>
              
              <div className="my-6">
                <span className="text-5xl font-extrabold text-[#18211c] dark:text-white">
                  ${billingCycle === "monthly" ? "49" : "39"}
                </span>
                <span className="text-sm text-[#55625b] dark:text-[#8fa397]"> / month</span>
              </div>
          ...
          <div className="bg-white dark:bg-[#111814]/80 border-2 border-[#009b98] p-8 rounded-2xl flex flex-col justify-between relative shadow-lg dark:shadow-2xl dark:shadow-[#009b98]/10 transform md:-translate-y-2">
            ...
            <div>
              ...
              <h3 className="text-2xl font-bold mt-2 text-[#18211c] dark:text-white">Growth Plan</h3>
              <p className="text-sm text-[#55625b] dark:text-[#8fa397] mt-2">Ideal for expanding residential teams.</p>
          ...
          <div className="bg-white dark:bg-[#111814]/40 border border-[#dfe5dc] dark:border-[#1f3026] p-8 rounded-2xl flex flex-col justify-between shadow-sm dark:shadow-none backdrop-blur-sm">
            <div>
              ...
              <h3 className="text-2xl font-bold mt-2 text-[#18211c] dark:text-white">Pro Plan</h3>
              <p className="text-sm text-[#55625b] dark:text-[#8fa397] mt-2">Built for multi-region operators.</p>
      ...
      {/* FAQ Section */}
      <section id="faqs" className="relative z-10 max-w-4xl mx-auto w-full px-6 sm:px-8 py-24 border-t border-[#dfe5dc] dark:border-[#1f3026]">
        <div className="text-center mb-16">
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#18211c] dark:text-white mb-4">
      ...
      <footer className="relative z-10 border-t border-[#dfe5dc] dark:border-[#1f3026] bg-[#fbfcf8] dark:bg-[#070c08] py-16 transition-colors duration-300">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 flex flex-col md:flex-row items-center justify-between gap-8">
          ...
          <div className="flex gap-6 text-xs text-[#7c8e82] dark:text-[#566e60]">
            <a href="#" className="hover:text-[#18211c] dark:hover:text-white transition-colors">Privacy Policy</a>
            <a href="#" className="hover:text-[#18211c] dark:hover:text-white transition-colors">Terms of Service</a>
            <a href="mailto:hello@afterservice.app" className="hover:text-[#18211c] dark:hover:text-white transition-colors">Contact</a>
          </div>
        </div>
      </footer>
    </div>
